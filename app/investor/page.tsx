    ...
    <div className="page inv-page">
      ...
      <div className="inv-intro">
        <div className="inv-intro-inner">
          ...
          <h1>
            Institutional memory is the <em>new bottleneck</em> in B2B sales. We
            own the layer.
          </h1>
          <p>
            Salency is a system of record for what your accounts actually told
            you — a structured, cited, queryable memory layer that every future
            revenue tool will inherit from. Below: what we&apos;re building,
            who&apos;s building it, and why this moat compounds.
          </p>
      ...
      <div className="reg-inv">
        <section className="platform" id="platform">
          ...
          <p>
            Salency is a system of record for what your accounts actually told
            you. Every call becomes <em>durable, queryable context</em> mapped
            to your product catalog, so the next rep, the next quarter, and the
            next pipeline review all inherit what was said — not what someone
            remembered to type.
          </p>
          <p>
            The primitive is structured account memory. The loop compounds:
            every call makes every future call smarter, for every future rep on
            that account. Every feature we ship — handoff docs, objection
        ...
        <section className="roadmap">
          <div className="roadmap-card">
            ...
            <span className="t">
              A <em>Recall.ai meeting bot</em> that joins Zoom, Meet, and Teams
              calls directly — feeding the extraction pipeline without a
          ...
          <div className="founder">
            ...
            <div className="body">
              ...
              <p className="bio">
                ...
                pilot-to-paid motions with the exact B2B buyers Salency sells to
                today. Before that, he led MUFG Hong Kong&apos;s first Panda
                Bond and handled business development at Sequence and Treasure.
                MBET, Waterloo.
              </p>
              <div className="fit">
                ...
                <p>
                  ...
                  rooms where the budget was real. The product spec comes from
                  that scar tissue — not from a market-map.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="founder rev">
            ...
            <div className="body">
              ...
              <p className="bio">
                ...
                internally. Prior background in institutional client management
                and AML/KYC compliance in banking.
              </p>
              <div className="fit">
                <div className="lbl">Unfair advantage</div>
                <p>
                  Knows what sales ops <em>actually trusts</em>, how handoffs
                  break at 50 reps, and which metrics survive a board deck. She
                  writes the go-to-market motion from the buyer&apos;s side of
                  the desk.
                </p>
              </div>
            </div>
        ...
        <section className="thesis" id="thesis">
          <div className="thesis-card">
            ...
            <p>
              ...
              <em>more accounts with less tribal knowledge</em>, and AI agents
              will start drafting their outreach inside the next eighteen
              months.
            </p>
            <p>
              ...
              inheriting the account doesn&apos;t either. The asset that makes
              either one useful is the same asset.
            </p>
            <div className="close">
              Salency owns that layer. The longer a team runs it,{' '}
              <em>the more context compounds</em> — and the harder it is to rip
              out.
            </div>
          </div>
        </section>
      ...
      <footer className="inv-footer">
        ...
        <nav>
          <a href="/">Product</a>
          <a href="mailto:howard@salency.com">Contact</a>
